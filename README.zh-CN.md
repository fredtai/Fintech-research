...
**100% 免费、自托管、Claude Code 原生，支持港股研究。用本地免费 MCP 服务器替代 15 万美元/年的机构数据栈，再以个性化交互层服务于卖方分析师、组合经理、个人投资者和学术经济学家。**
...
3. **本地免费数据 MCP。** 自托管 MCP 服务器整合 yfinance + HKEX 披露易 + FRED + NewsAPI + RSS，完全免费零订阅。港股（恒指前 50 + 科技龙头）、美股、A 股全覆盖。
