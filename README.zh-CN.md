...
**一个自包含的代码库，把你的 Claude Code 变成股票研究 Agent。让每位投资者都能用上 Anthropic 官方的股票研究 Skills —— 用单一数据 MCP 替代 15 万美元/年的机构数据栈，再以个性化交互层服务于卖方分析师、组合经理、个人投资者和学术经济学家。**
...
- **[Drillr](https://drillr.ai)** —— 支撑所有 skill 的单一数据 MCP（基本面、SEC 文件、企业关系图谱、另类数据、宏观与市场信号）
